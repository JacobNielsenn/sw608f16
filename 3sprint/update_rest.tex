...
We plan on implementing an update to the RESTful proxy server that is used to communicate with AAU's MSE. This update is a consequence of MSE being updated to support geographic coordinates. The update is planned to remove a bug causing loss of data during conversion between different data formats. This section covers the motivation for the following changes in the update:
...
>>>>>>> 238895e804f0180b7e79f3adc04cb6fa1f893bfa
