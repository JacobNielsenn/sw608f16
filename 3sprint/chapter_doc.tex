...
During this sprint we examined the possibility of building a small tracking system utilising access points. The goal was to have a system that is comparable with MSE in terms of the precision of the geo-coordinates. We were not able to make a functional IPS as we were unable to retrive the RSSI from the routers and access points. \Cref{sec:future_system} will function as a guidance and proposal section for how to continue the development of the system.
...
%TODO Skriv om security
\afx{Write the sprint review for security when the conclusion is done}