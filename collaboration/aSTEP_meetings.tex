...
There was also held a meeting with the UM group where there were discussed HTTP vs HTTPS, initially we and the UM group were not able to setup the HTTPS correctly in the time we estimated, we then explained our approach to aSTEP, then Alexander Krog from HotMaps apps said he had experience with this and fixed the code so aSTEP now runs on HTTPS. This lead to the next problem making the authentication by a third part. This was done by the company lets encrypt.