...
There was also held a meeting with the UM group where there were discussed http vs https, initially we and the UM group were not able to use https with our current setup of the RESTFUL service, we then explained our approach to aSTEP, then Alexander Krog from HotMaps apps said they had experience with this and made it possible for aSTEP to use https. This lead to the next problem making the authentication by a third part. This was done by the company lets encrypt.