...
\ofx{Bin says "so far, the collaboration is on project managing and a common service gitlab. I think in the next 2 sprints, you need to consider add a collaboration on some specific functionality. do you have an idea already?"}
...
\input{collaboration/code_documentation}
