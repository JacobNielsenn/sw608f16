...
This section will describe different technologies and systems using these technologies, for indoor positioning and monitoring of multiple mobile devices. Two technologies will be described for indoor positioning, WI-FI and Radio Frequency Identification (RFID). \sfx{use glossary on this} \sfx{bluetooth?}
