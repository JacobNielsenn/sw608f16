\section{Oversee Mobile Devices}\label{sec:monitoring} \sfx{bad name}
...
Aalborg University uses the standard version of MSE to position wireless devices across all their campuses. We plan on using the data available from this system as dummy data for the aStep project.